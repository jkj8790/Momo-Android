...
class DiskMapDataStore @Inject constructor(
  ...
  override fun createMap(name: String, description: String,
      isPrivate: Boolean, authorId: Long, authorName: String): Observable<MomoMapEntity> {
    val id = db.insert("map", SQLiteDatabase.CONFLICT_REPLACE,
  ...
  private fun createContentValues(name: String, description: String,
      isPrivate: Boolean, authorId: Long, authorName: String): ContentValues {
