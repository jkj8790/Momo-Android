...
class CreatePin (
  ...
  data class Params(val name: String, val pinType: PinType,
      val authorId: Long, val authorName: String, val mapId: Long)

  override fun buildObservable(params: Params): Observable<Pin> {
    return pinRepository.createPin(params.name, params.pinType,
