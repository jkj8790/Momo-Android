...
class CreateMap (
  ...
  data class Params(val name: String, val description: String, val isPrivate: Boolean,
      val authorId: Long, val authorName: String)

  override fun buildObservable(params: Params): Observable<MomoMap> {
    return mapRepository.createMap(params.name, params.description, params.isPrivate,
